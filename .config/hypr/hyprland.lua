...
-- Requires Hyprland 0.55 or newer, where hyprlang configs are replaced by Lua.
...
-- Start background services when Hyprland starts.
...
hl.bind(mainMod .. " + space", hl.dsp.exec_cmd("~/.config/rofi/launchers/type-2/launcher.sh || pkill rofi"))
